      ...
      <main className='main--project'>
        ...
        <section>
          <article className=''>
            <div className="grid md:grid-cols-[minmax(30vw,1.8fr),1fr] gap-[2rem]">
              ...
              <div className='md:sticky md:top-[6rem] h-fit'>
                ...
                <div className="flex items-center gap-[.5em] pb-2">
                ...
                <div className=" changes-color-container colors7">
          ...
          <Image key={index} src={image.img} alt={`Cover ${index + 1}`} width='350' height='400' className='mx-auto' />
              ...
              <div className='grid gap-[1rem] pt-[3.5em] '>

                <div className='changes-color-container colors1'>
                  <div
                  // className=" changes-color-container colors7"
                  >
